...
已完成（2026-09-12）。P1b 复用 [P1a 的固定编辑器布局](p1a.md)，把 P0 固定时间线扩展为可编译的教程协议。目录与 target 能力已由 [P1c](p1c.md) 扩展，下表记录 P1b 基线；P2 常规编辑已扩展，当前支持范围见 [P2 矩阵](p2.md)。P3 观众视口交互尚未实现。
