...
const project = targetProject(),
  ...
  out = resolve('artifacts/catalog-reference');
...
zip.file(
  ...
  JSON.stringify({
    ...
    monitors: [],
    extensions: [],
    meta: { semver: '3.0.0', vm: '0.2.0', agent: 'Motion catalog reference' },
  }),
);
...
try {
  ...
  // Match the supported core menu configuration; retain the pinned visual addons.
