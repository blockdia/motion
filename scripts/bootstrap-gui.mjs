...
import { guiCommit } from '../packages/adapter-turbowarp/dist/index.js';
const source = { repository: 'https://github.com/TurboWarp/scratch-gui', commit: guiCommit };
...
const archive = execFileSync('git', ['-C', checkout, 'archive', source.commit], {
